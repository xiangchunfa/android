...
/**
 * 银行卡编辑框
 * create at 2015-02-12
 * @author antony
 *
 */
public class BankCardNoClearEditText extends EditText implements TextWatcher,OnFocusChangeListener {
	
	private static final String TAG = BankCardNoClearEditText.class.getSimpleName();
	...
	public BankCardNoClearEditText(Context context) {
		this(context, null);
		this.mContext = context;
	}
	
	public BankCardNoClearEditText(Context context, AttributeSet attrs) {
